...
static const _GripperStatus_type_support_symbol_names_t _GripperStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robotiq_gripper, msg, GripperStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robotiq_gripper, msg, GripperStatus)),
  }
};
...
{
  return &::robotiq_gripper::msg::rosidl_typesupport_cpp::GripperStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robotiq_gripper, msg, GripperStatus)() {
  return get_message_type_support_handle<robotiq_gripper::msg::GripperStatus>();
}
